  ...
  <view :class="['test-page', containerClasses]" :style="{'--theme-color': themeColor}">
    ...
    <view class="question-card">
      ...
      <scroll-view scroll-y class="question-content">
        ...
        <text class="question-tip">请根据您的真实想法选择</text>
      </scroll-view>
    </view>
      ...
      <view class="result-content" @click.stop>
        ...
        <view class="result-body">
          ...
          <view class="level-section">
            ...
            <text class="level-value" :class="getLevelClass(resultData.trustLevel)">{{resultData.trustLevel}}</text>
          </view>
      ...
      questions: [
        {
          ...
          options: [
            ...
            { text: "不确定", desc: "3分", score: 3 },
            { text: "同意", desc: "4分", score: 4 },
            { text: "完全同意", desc: "5分", score: 5 }
          ]
        },
        {
          id: 2,
  ...
  methods: {
    ...
    submitTest() {
      ...
      if (totalScore >= 12 && totalScore <= 24) {
        trustLevel = '低信任水平'
        levelDescription = '您对他人的信任水平较低，可能对人际关系保持谨慎态度。'
        suggestion: '建议适当开放心态，尝试与值得信赖的人建立更深入的关系，逐步提高对他人的信任。'
      } else if (totalScore >= 25 && totalScore <= 36) {
        trustLevel = '中等信任水平'
        levelDescription = '您对他人的信任水平适中，能够平衡信任与谨慎。'
        suggestion: '继续保持这种平衡，在建立信任关系时保持理性判断。'
      } else if (totalScore >= 37 && totalScore <= 48) {
        trustLevel = '较高信任水平'
        levelDescription = '您对他人的信任水平较高，容易与他人建立良好关系。'
        suggestion: '继续保持开放的心态，但也要学会保护自己，避免过度信任可能带来的风险。'
      } else if (totalScore >= 49 && totalScore <= 60) {
        trustLevel = '高信任水平'
        levelDescription = '您对他人的信任水平很高，容易与他人建立深厚的信任关系。'
        suggestion: '您具有很好的信任能力，但要注意在信任他人的同时也要学会保护自己。'
      }
