<template>
    <view
        :class="['history-container', containerClasses]"
                ...
                >
                    <view class="card-header">
                        <view class="test-info">
                            <text class="test-emoji">{{
                                getTestEmoji(item.questionnaireName)
                            }}</text>
                            <view class="test-details">
                                <text class="test-name">{{
                                    getTestDisplayName(item.questionnaireName)
                                }}</text>
                                <text class="test-date">{{
                        ...
                        <view
                            class="score-badge"
                            :class="getScoreClass(item.depressionLevel)"
                        >
                            <text class="score-text">{{
                                getScoreText(item.depressionLevel)
                            }}</text>
                        </view>
                    </view>
                    ...
                    <view class="card-footer">
                        <view
                            class="result-tag"
                            :class="getResultTagClass(item.depressionLevel)"
                        >
            ...
            <view class="detail-content" @click.stop>
                ...
                <view class="detail-body">
                    ...
                    <view class="detail-section">
                        ...
                        <text
                            class="section-value result-value"
                            :class="getScoreClass(selectedItem.depressionLevel)"
                        >
                    ...
                    <view class="detail-section">
                        ...
                        <text class="section-value description">{{
                ...
                <view class="detail-footer">
                    <button class="detail-btn" @click="closeDetail">
                        关闭
                    </button>
                </view>
            </view>
    ...
    methods: {
        async loadHistoryData() {
            try {
                ...
                const result =
                    await this.$api.questionnaire.getUserResults(userId);
